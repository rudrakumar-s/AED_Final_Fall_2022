...
public CustomerPhoneComplain(String s) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtCustomerId, new org.netbeans.lib.awtextra.AbsoluteConstraints(178, 284, 299, 30));
        ...
        jPanel1.add(txtProductID, new org.netbeans.lib.awtextra.AbsoluteConstraints(178, 332, 299, 32));

        jLabel7.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("Product ID :");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 332, 119, 30));
        jPanel1.add(txtRentId, new org.netbeans.lib.awtextra.AbsoluteConstraints(178, 376, 299, 29));
        ...
        jPanel1.add(txtDelay, new org.netbeans.lib.awtextra.AbsoluteConstraints(178, 423, 299, 29));
        ...
        jPanel1.add(txtFine, new org.netbeans.lib.awtextra.AbsoluteConstraints(178, 470, 299, 29));
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 100, 436, 104));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(455, 0, 1650, 1340));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 450, 1340));
    ...
    private void btnPaymentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPaymentActionPerformed
        // TODO add your handling code here:
        String sql1 ="UPDATE customers SET phoneaproove = NULL ,delay = NULL,phonefine = NULL,phoneprice = NULL,"
                + "phonecomplain = NULL,phonerentid = NULL,phonerentd = NULL,phonereturnd = NULL, phoneid = NULL WHERE customerid = '"+txtCustomerId.getText()+"' ";
    ...
    private void DisplayPhoneOnRent() {
        ...
        try{
            ...
            while (rs.next()) {
                  reg = rs.getString(34);
                 brand = rs.getString(22);
                 carmodel = rs.getString(26);
